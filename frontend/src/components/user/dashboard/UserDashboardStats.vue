<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <!-- Balance -->
    <div v-if="!isSimple" class="card card-hover p-4 animate-fade-up">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="truncate text-xl font-bold tabular-nums text-emerald-600 dark:text-emerald-400">${{ formatBalance(balance) }}</p>
    ...
    <!-- API Keys -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 40ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-xl font-bold tabular-nums text-gray-900 dark:text-white">{{ stats?.total_api_keys || 0 }}</p>
    ...
    <!-- Today Requests -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 80ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-xl font-bold tabular-nums text-gray-900 dark:text-white">{{ stats?.today_requests || 0 }}</p>
    ...
    <!-- Today Cost -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 120ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="truncate text-xl font-bold tabular-nums text-gray-900 dark:text-white">
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <!-- Today Tokens -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 160ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-xl font-bold tabular-nums text-gray-900 dark:text-white">{{ formatTokens(stats?.today_tokens || 0) }}</p>
    ...
    <!-- Total Tokens -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 200ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-xl font-bold tabular-nums text-gray-900 dark:text-white">{{ formatTokens(stats?.total_tokens || 0) }}</p>
    ...
    <!-- Performance (RPM/TPM) -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 240ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-xl font-bold tabular-nums text-gray-900 dark:text-white">{{ formatTokens(stats?.rpm || 0) }}</p>
            <span class="text-xs text-gray-500 dark:text-gray-400">RPM</span>
          </div>
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold tabular-nums text-violet-600 dark:text-violet-400">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <!-- Avg Response Time -->
    <div class="card card-hover p-4 animate-fade-up" style="animation-delay: 280ms">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          ...
          <p class="text-xl font-bold tabular-nums text-gray-900 dark:text-white">{{ formatDuration(stats?.average_duration_ms || 0) }}</p>
